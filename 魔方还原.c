...
void Input(Cube *magiccube)//存储魔方
{
	...
	InputSurface(&(magiccube->up));//储存顶面
	printf("Input the colors of Down:\n");
	InputSurface(&(magiccube->down));//储存底面
	printf("Input the colors of Front:\n");
	InputSurface(&(magiccube->front));//储存前面
	printf("Input the colors of Back:\n");
	InputSurface(&(magiccube->back));//储存后面
	printf("Input the colors of Left:\n");
	InputSurface(&(magiccube->left));//储存左面
	printf("Input the colors of Right:\n");
	InputSurface(&(magiccube->right));//储存右面
}
...
{
	/*m->up.s[1][1]=(Colors)5;m->up.s[1][2]=(Colors)1;m->up.s[1][3]=(Colors)3;
	m->up.s[2][1]=(Colors)6;m->up.s[2][2]=(Colors)2;m->up.s[2][3]=(Colors)3;
	m->up.s[3][1]=(Colors)2;m->up.s[3][2]=(Colors)5;m->up.s[3][3]=(Colors)1;

	m->down.s[1][1]=(Colors)2;m->down.s[1][2]=(Colors)4;m->down.s[1][3]=(Colors)3;
	m->down.s[2][1]=(Colors)4;m->down.s[2][2]=(Colors)6;m->down.s[2][3]=(Colors)3;
	m->down.s[3][1]=(Colors)2;m->down.s[3][2]=(Colors)1;m->down.s[3][3]=(Colors)3;

	m->front.s[1][1]=(Colors)1;m->front.s[1][2]=(Colors)2;m->front.s[1][3]=(Colors)6;
	m->front.s[2][1]=(Colors)1;m->front.s[2][2]=(Colors)1;m->front.s[2][3]=(Colors)2;
	m->front.s[3][1]=(Colors)5;m->front.s[3][2]=(Colors)5;m->front.s[3][3]=(Colors)4;

	m->back.s[1][1]=(Colors)1;m->back.s[1][2]=(Colors)2;m->back.s[1][3]=(Colors)6;
	m->back.s[2][1]=(Colors)4;m->back.s[2][2]=(Colors)4;m->back.s[2][3]=(Colors)6;
	m->back.s[3][1]=(Colors)4;m->back.s[3][2]=(Colors)5;m->back.s[3][3]=(Colors)5;
	
	m->left.s[1][1]=(Colors)4;m->left.s[1][2]=(Colors)1;m->left.s[1][3]=(Colors)3;
	m->left.s[2][1]=(Colors)5;m->left.s[2][2]=(Colors)3;m->left.s[2][3]=(Colors)3;
	m->left.s[3][1]=(Colors)1;m->left.s[3][2]=(Colors)2;m->left.s[3][3]=(Colors)4;

	m->right.s[1][1]=(Colors)5;m->right.s[1][2]=(Colors)4;m->right.s[1][3]=(Colors)6;
	m->right.s[2][1]=(Colors)3;m->right.s[2][2]=(Colors)5;m->right.s[2][3]=(Colors)6;
	m->right.s[3][1]=(Colors)2;m->right.s[3][2]=(Colors)6;m->right.s[3][3]=(Colors)6;*/
